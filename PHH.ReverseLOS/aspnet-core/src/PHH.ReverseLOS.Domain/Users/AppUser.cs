...
namespace PHH.ReverseLOS.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ReverseLOSDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ReverseLOSEfCoreEntityExtensionMappings to extend the IdentityUser entity
