...
namespace PHH.ReverseLOS.ObjectExtending
{
    public static class ReverseLOSDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the ReverseLOSEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
